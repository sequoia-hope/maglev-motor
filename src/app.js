...
const PRESETS = {
  ...
  pcb: {
    ...
    blurb: 'The larger of the two PCB stages, same recipe as the small one: Carl Bugeja\'s 12-layer coil stitched with plated through-holes only (no blind/buried vias, so a fab will actually press it), 1 oz (35 µm) copper at its 0.103 mm minimum trace, 12 turns per layer on a 1.57 mm board — wound deep to the centre, corners rounded so the crossover vias sit in copper-free pockets. Fill is set to the densest value (0.88) that still routes clean: every plated through-hole is checked, and none contacts a layer it must not (validatePcb). Copper weight is the wall — Bugeja\'s fab rule (4 mil per ounce) means you cannot have both many turns and low current density. Over a 72 mm 2-D Halbach platen at λ = 24 mm it flies everywhere, no dead spots: 14.8× lift centred and 14.7× at the workspace corners, at a 2.0 mm gap over a 1.79 mm floor, off 324 spirals grouped into 36 amplifiers, 14.5 W hover, 29 K board rise. Still heat-first: the thin 1 oz copper carries the hover current at 94 A/mm². The magnets are catalogue stock — 6×6×3 mm N52 blocks (Supreme), 25 axial + 60 in-plane (the in-plane block is the same part magnetised through a 6 mm edge), 85 magnets in 121 pockets, 66.0 mm across on a 72 mm platen. For a lighter, cooler board see the small PCB stage.',
    cfg: {
      ...
      stator: { coilType: 'pcb', coilPitch: 0.008, coilFill: 0.88, statorSize: 0.144, windingHeight: 0.0016, wireDiameter: 0.0005, pcbLayers: 12, pcbTraceWidth: 0.000103, pcbCopperThickness: 35e-6, lockCoilPitch: false },
  ...
  pcbmini: {
    ...
    cfg: {
      ...
      stator: { coilType: 'pcb', coilPitch: 0.008, coilFill: 0.88, statorSize: 0.096, windingHeight: 0.0016, wireDiameter: 0.0005, pcbLayers: 12, pcbTraceWidth: 0.000103, pcbCopperThickness: 35e-6, lockCoilPitch: false },
